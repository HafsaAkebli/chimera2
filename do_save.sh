...
output_filename="/mnt/dmif-nas/MITEL/hafsa/chimera_bcg/container/${DOCKER_IMAGE_TAG}_${formatted_build_info}.tar.gz"
#folder where to save the container
...
# Create the tarbal
#echo "==+=="
#output_tarball_name="${SCRIPT_DIR}/nmodel1.tar.gz"
